...
let HealthCheckService = class HealthCheckService {
    constructor(postgresHealthCheckRepository) {
        this.postgresHealthCheckRepository = postgresHealthCheckRepository;
    }
    async checkStatusAPI() {
        logger_1.default.debug('healthCheckService - checkStatusAPI - postgresHealthCheckRepository');
...
HealthCheckService = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('HealthCheckRepositoryInterface')),
